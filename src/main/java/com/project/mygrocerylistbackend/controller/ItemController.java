...
public class ItemController {
    ...
    @PostMapping("/user/{userId}/groceryList/{groceryListId}/category/{categoryId}")   // url -> http://localhost:9092/api/user/userId/groceryList/groceryListId/category/categoryId
